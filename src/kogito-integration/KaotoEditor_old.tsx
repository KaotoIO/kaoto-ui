...
// // interface ContentState extends UndoState {
// //   content: string;
// //   updateContentState: (newContent: string) => void;
// //   clearContentState: () => void;
// // }

// // // creates a store with undo/redo capability
// // const useContentStoreWithHistory = create<ContentState>((set) => ({
// //   content: "",
// //   updateContentState: (newContent: string) => set(() => ({ content: newContent })),
// //   clearContentState: () => set({ content: "" }),
// // }));
