...
export const integrationSteps: IStepProps[] = [
  {
    name: 'timer',
    type: 'START',
    id: 'timer-consumer',
...
export const flowWithBranch: IIntegration = {
  id: 'route-1814',
  dsl: 'Camel Route',
  description: '',
  metadata: {
  ...
  steps: [
    ...
    },
    {
      ...
      branches: [
        {
          branchUuid: 'route-1814_pipeline-1_branch-0',
          identifier: '',
          steps: [
            {
              name: 'log',
              ...
              minBranches: 0,
              maxBranches: 0,
              UUID: 'route-1814_pipeline-1_branch-0_log-0',
              integrationId: 'route-1814',
            },
          ],
        },
