...
const RefForwardingServerlessWorkflowTextEditor: ForwardRefRenderFunction<
...
export const ServerlessWorkflowTextEditor = forwardRef(RefForwardingServerlessWorkflowTextEditor);
