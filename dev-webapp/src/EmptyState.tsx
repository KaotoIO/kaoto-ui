...
export const KaotoEmptyState = (props: AllProps) => (
  <EmptyState variant={EmptyStateVariant.small}>
    ...
    <EmptyStateBody>
      A Kaoto Document is required to enable the editor. Please either upload an existing document or create a new one or
      select a sample.
    </EmptyStateBody>
